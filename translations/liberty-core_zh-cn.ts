...
<context>
    ...
    <message>
        ...
        <translation>这会使发送或接收Liberty更加简单，并且减少在手动输入地址时发生的错误。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告：请勿在别的分叉上重用你的 Liberty 私钥，除非这个分叉内置了重用保护，否则隐私会受到侵害。</translation>
    </message>
    <message>
        ...
        <translation>警告：复制种子单词到剪贴板，可能会暴露给恶意软件，导致你的种子单词被记录，从而Liberty被盗。请手工抄写下这些种子单词。</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Liberty. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>挖矿有助于增强Liberty网络。挖矿的人越多，攻击网络就会越困难，一点一滴的算力亦有帮助。

挖矿的同时也给予一点小概率的Liberty作为收益回报。你的电脑将产生许多哈希值，来寻找打包区块的答案。如果你成功找到一个区块，将会得到相关的奖励。祝你好运！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>内置 Liberty 版本：</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>使用一个第三方的服务器连接到 Liberty 网络。安全性较低，但更加轻便。</translation>
    </message>
    <message>
        ...
        <translation>可以在搜索引擎中查找“Liberty 远程节点”。请注意确保节点由一个可信任的第三方维护。</translation>
    </message>
    <message>
...
你可以在钱包设置中修改密码。</translation>
    ...
    <message>
        ...
        <translation>让您的企业轻松使用自由币</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>您在本页面可以操作共享的环形签名数据库。该数据库可被自由币钱包和克隆钱包的密钥重用。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为了掩盖Liberty交易中任何付款的去向，第三方不应知道环签名中每个输入和输出的对应关系。否则就会削弱环签名提供的保护作用。如果仅有一个输入之外的所有输入都已知，那么所有付款的去向将变得透明，这将使作为自由币三个主要隐私保护层之一的环签名彻底无效。&lt;br&gt; 为帮助交易中避免出现这些问题，可以使用已知去向交易清单来避免在新交易中使用它们。这个清单由自由币项目维护，可在 getliberty.org 网站上找到，您可以在此处导入此清单。 &lt;br&gt; 或者您可以自己扫描区块链 （以及复制了自由币密钥的克隆钱包的区块链），使用liberty-blockchain-mark-spent-outputs 工具创建已知的已用输出清单。 &lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为避免 Liberty 环签名所提供的保护被破坏，某个输出不应在别的链上与别的成员结成一个新环而被再次花费掉（这样会导致产生相同的 key image）。尽管这看上去不是什么问题，但当一个重用密钥的 Liberty 拷贝可以让你重新消费已被消费的输出时，这是个大问题。这里，你必须保证这个已存在的输出在两条链上使用了相同的环。&lt;br&gt;Liberty 和其他一些无意伤害你的隐私的重用 Liberty 私钥的软件会自动处理这些。&lt;br&gt;如果你也在使用一个重用私钥的 Liberty 拷贝，而且这个拷贝没有包含这样的保护，你的交易仍然可以在那个拷贝上得到保护，但你需要手动将环输入到此页中，以便你能在后续安全地花费你的 Liberty。&lt;br&gt;如果你没有使用一个不附带此安全特性的重用私钥的 Liberty 拷贝的话，那么你什么都不用做，一切都是自动的。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>这个环签名已在密钥重用的Liberty链上使用过, 因此重复使用同一个环签名可以避免隐私问题. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>输入Liberty地址 (例如: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
环签名大小: </translation>
    ...
    <message>
        ...
        <translation>花费冷(线下)钱包里的自由币</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>为了能够与Liberty网络通信，您的钱包需要连接到一个Liberty节点。为了最好的隐私，建议运行您自己的节点。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>除此之外，你还可以指定一个引导节点来快速的使用Liberty。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>如果这是您第一次使用Liberty，请选择此选项。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>连接您的硬件钱包，以创建一个新Liberty钱包。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>远程模式可以让您立即使用自由钱包，但需要注意：当使用远程模式 (包括引导模式)，节点可能会追踪您的IP地址，“钱包恢复高度”，以及相关的区块请求信息，且可以通过向您发送不正确的信息以获取更多关于您的交易信息。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>该模式非常适合管理少量的Liberty。您可以访问用于创建和管理交易的基本功能。它会自动连接到Liberty网络，所以您可以立即开始使用Liberty。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>你的钱包需要与自由币节点连接后，才能和自由币网络发生通讯。处于最佳隐私考虑，推荐你使用自己运行的节点。
...
<context>
    ...
    <message>
        ...
        <translation>这个地址接收了 %1 个Liberty, 并通过 %2 次的确认. </translation>
    </message>
    <message>
        <location filename="../main.qml" line="1067"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>这个地址将收到 %1 个liberty币, 但这笔交易尚未被矿工确认</translation>
    </message>
    <message>
