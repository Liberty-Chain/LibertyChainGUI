        ...
        Item {
            ...
            Item {
                ...
                LibertyComponents.TextPlain {
                    ...
                    font.bold: false
                    color: "white"
                    text: "<style type='text/css'>a {text-decoration: none; color: #D9A83E; font-size: 12px;}</style>%1: %2 <a href='#'>(%3)</a>"
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    LibertyComponents.TextPlain {
                        ...
                        font.bold: false
                        color: "white"
                        text: qsTr("Amount to receive") + " (MLBT)" + translationManager.emptyString
                        themeTransition: false
                    }
                    ...
                    LibertyComponents.TextPlain {
                        // @TODO: When we have MLBT/USD rate avi. in the future.
                        visible: false
                        font.pixelSize: 14
                        font.bold: false
                        color: "white"
