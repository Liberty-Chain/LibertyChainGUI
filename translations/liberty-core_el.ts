...
<context>
    ...
    <message>
        ...
        <source>This makes it easier to send or receive Liberty and reduces errors when typing in addresses manually.</source>
        <translation>Αυτό διευκολύνει την αποστολή ή λήψη του Liberty και μειώνει τα σφάλματα κατά τη χειροκίνητη πληκτρολόγηση διευθύνσεων.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>WARNING: Do not reuse your Liberty keys on another fork, UNLESS this fork has key reuse mitigations built in. Doing so will harm your privacy.</source>
        <translation>ΠΡΟΣΟΧΗ: Μην επαναχρησιμοποιείτε τα κλειδιά του Liberty σε άλλη διακλάδωση, ΕΚΤΟΣ κι αν αυτή η διακλάδωση έχει ενσωματωμένο μετριασμό επαναχρησιμοποίησης κλειδιού . Κάνοντας το αυτό θα βλάψει την ιδιωτικότητα σας.</translation>
    </message>
    <message>
        <location filename="../pages/Keys.qml" line="85"/>
        <source>WARNING: Copying your seed to clipboard can expose you to malicious software, which may record your seed and steal your Liberty. Please write down your seed manually.</source>
        <translation>ΠΡΟΣΟΧΗ: Αντιγράφοντας την φράση σας στο πρόχειρο μπορεί να σας εκθέσει σε κακόβουλο λογισμικό, το οποίο μπορεί να καταγράψει την φράση σας και να κλέψει τα Liberty σας. Παρακαλώ γράψτε την φράση σας χειροκίνητα.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Mining with your computer helps strengthen the Liberty network. The more that people mine, the harder it is for the network to be attacked, and every little bit helps.

Mining also gives you a small chance to earn some Liberty. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Η εξόρυξη με τον υπολογιστή σας βοηθά στην ενίσχυση του δικτύου Liberty. Όσο περισσότερο οι άνθρωποι κάνουν εξόρυξη, τόσο πιο δύσκολο είναι να γίνει επίθεση κατά του δικτύου, και κάθε βοήθεια είναι χρήσιμη.

Η εξόρυξη σας δίνει επίσης μια μικρή ευκαιρία να κερδίσετε Liberty. Ο υπολογιστής σας θα δημιουργήσει hashes αναζητώντας λύσεις για τα block. Εάν βρείτε ένα block, θα λάβετε τη σχετική ανταμοιβή. Καλή τύχη!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Embedded Liberty version: </source>
        <translation>Ενσωματωμένη έκδοση Liberty: </translation>
    </message>
    <message>
...
Το παλιό αρχείο προσωρινής μνήμης πορτοφολιού θα μετονομαστεί και μπορεί να αποκατασταθεί αργότερα.
    ...
    <message>
        ...
        <source>Donate to Liberty</source>
        <translation>Κάντε δωρεά στο Liberty</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <source>Uses a third-party server to connect to the Liberty network. Less secure, but easier on your computer.</source>
        <translation>Χρησιμοποιεί διακομιστή από τρίτο πάροχο για τη σύνδεση στο δίκτυο του Liberty. Λιγότερο ασφαλές, αλλά ελαφρύτερο για τον υπολογιστή σας.</translation>
    </message>
    <message>
        <location filename="../pages/settings/SettingsNode.qml" line="262"/>
        <source>To find a remote node, type &apos;Liberty remote node&apos; into your favorite search engine. Please ensure the node is run by a trusted third-party.</source>
        <translation>Για την εύρεση απομακρυσμένου κόμβου, πληκτρολογήστε &apos;Liberty remote node&apos; στην αγαπημένη σας μηχανή αναζήτησης. Παρακαλώ διαβεβαιώστε πως ο κόμβος λειτουργεί μέσω αξιόπιστου τρίτου παρόχου.</translation>
    </message>
    <message>
...
Μπορείτε να αλλάξετε τον κωδικό πρόσβασης στις ρυθμίσεις πορτοφολιού.</translation>
    ...
    <message>
        ...
        <source>Receive Liberty for your business, easily.</source>
        <translation>Λάβετε Liberty για την επιχείρηση σας με ευκολία.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This page allows you to interact with the shared ring database. This database is meant for use by Liberty wallets as well as wallets from Liberty clones which reuse the Liberty keys.</source>
        <translation>Αυτή η σελίδα σας επιτρέπει την αλληλεπίδραση με την κοινόχρηστη βάση δεδομένων δαχτυλιδιού. Αυτή η βάση δεδομένων προορίζεται για χρήση στα πορτοφόλια του Liberty, όπως και κλώνους του, οι οποίοι επαναχρησιμοποιούν τα κλειδιά του Μonero.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to obscure which inputs in a Liberty transaction are being spent, a third party should not be able to tell which inputs in a ring are already known to be spent. Being able to do so would weaken the protection afforded by ring signatures. If all but one of the inputs are known to be already spent, then the input being actually spent becomes apparent, thereby nullifying the effect of ring signatures, one of the three main layers of privacy protection Liberty uses.&lt;br&gt;To help transactions avoid those inputs, a list of known spent ones can be used to avoid using them in new transactions. Such a list is maintained by the Liberty project and is available on the getliberty.org website, and you can import this list here.&lt;br&gt;Alternatively, you can scan the blockchain (and the blockchain of key-reusing Liberty clones) yourself using the liberty-blockchain-mark-spent-outputs tool to create a list of known spent outputs.&lt;br&gt;</source>
        <translation>Για να αποκρύψετε ποιες είσοδοι ξοδεύονται σε μια συναλλαγή Liberty, ένας τρίτος δεν πρέπει να είναι σε θέση να ξεχωρίσει το ποιες είσοδοι είναι ήδη γνωστό ότι δαπανώνται σε έναν δακτύλιο. Το να μπορεί να γίνει αυτό θα εξασθενίσει την προστασία που παρέχεται από τις υπογραφές του δακτυλίου. Εάν είναι γνωστό ότι έχουν ήδη δαπανηθεί όλες εκτός από μία από τις εισόδους, τότε η είσοδος που ξοδεύεται στην πραγματικότητα γίνεται εμφανής, ακυρώνοντας έτσι την επίδραση των υπογραφών του δακτυλίου, ένα από τα τρία βασικά επίπεδα προστασίας της ιδιωτικότητας που χρησιμοποιεί το Liberty. &lt;br&gt;Για να βοηθήσετε τις συναλλαγές να αποφύγουν αυτές τις εισροές, μια λίστα γνωστών δαπανών μπορεί να χρησιμοποιηθεί για να αποφευχθεί η χρήση τους σε νέες συναλλαγές. Μια τέτοια λίστα διατηρείται από το Liberty και είναι διαθέσιμη στον ιστότοπο getliberty.org και μπορείτε να εισάγετε αυτήν τη λίστα εδώ. &lt;br&gt;Εναλλακτικά, μπορείτε να σαρώσετε μόνοι σας το blockchain (και τα blockchain των κλώνων Liberty που επαναχρησιμοποιούν κλειδιά) με το εργαλείο liberty-blockchain-mark-spent-outputs για τη δημιουργία μιας λίστας γνωστών εξαγόμενων δαπανών.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to avoid nullifying the protection afforded by Liberty&apos;s ring signatures, an output should not be spent with different rings on different blockchains. While this is normally not a concern, it can become one when a key-reusing Liberty clone allows you to spend existing outputs. In this case, you need to ensure this existing outputs uses the same ring on both chains.&lt;br&gt;This will be done automatically by Liberty and any key-reusing software which is not trying to actively strip you of your privacy.&lt;br&gt;If you are using a key-reusing Liberty clone too, and this clone does not include this protection, you can still ensure your transactions are protected by spending on the clone first, then manually adding the ring on this page, which allows you to then spend your Liberty safely.&lt;br&gt;If you do not use a key-reusing Liberty clone without these safety features, then you do not need to do anything as it is all automated.&lt;br&gt;</source>
        <translation>Προκειμένου να αποφευχθεί η ακύρωση της προστασίας που παρέχεται από τις υπογραφές δακτυλίων του Liberty, μια έξοδος δεν πρέπει να δαπανάται με διαφορετικούς δακτυλίους σε διαφορετικά blockchain. Αν και αυτό συνήθως δεν προκαλεί ανησυχία, μπορεί να προκαλέσει όταν ο κλώνος Liberty που επαναχρησιμοποιεί τα κλειδιά, σας επιτρέπει να ξοδέψετε υπάρχουσες εξόδους. Σε αυτήν την περίπτωση, πρέπει να διασφαλίσετε ότι η υπάρχουσα έξοδος χρησιμοποιεί τον ίδιο δακτύλιο και στις δύο αλυσίδες. &lt;br&gt;Αυτό θα γίνει αυτόματα από το Liberty και από οποιοδήποτε λογισμικό επαναχρησιμοποίησης κλειδιών που δεν προσπαθεί να αφαιρέσει ενεργά το απόρρητό σας. &lt;br&gt;Εάν χρησιμοποιείτε και έναν κλώνο Liberty που επαναχρησιμοποιεί κλειδιά και αυτός ο κλώνος δεν περιλαμβάνει αυτήν την προστασία, μπορείτε ακόμα να διασφαλίσετε ότι οι συναλλαγές σας προστατεύονται δαπανώντας πρώτα στον κλώνο και, στη συνέχεια, προσθέτοντας χειροκίνητα τον δακτύλιο σε αυτήν τη σελίδα, όπου σας επιτρέπει να ξοδέψετε το Liberty σας με ασφάλεια. &lt;br&gt;Εάν δεν χρησιμοποιείτε κλώνο Liberty που επαναχρησιμοποιεί κλειδιά χωρίς αυτά τα χαρακτηριστικά ασφαλείας, τότε δεν χρειάζεται να κάνετε τίποτα, καθώς όλα είναι αυτοματοποιημένα.&lt;br&gt;</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="279"/>
        <source>This records rings used by outputs spent on Liberty on a key reusing chain, so that the same ring may be reused to avoid privacy issues.</source>
        <translation>Αυτό καταγράφει δακτυλίους που χρησιμοποιούνται από εξόδους που δαπανήθηκαν στο Liberty σε μια αλυσίδα επαναχρησιμοποίησης κλειδιών, έτσι ώστε ο ίδιος δακτύλιος να μπορεί να επαναχρησιμοποιηθεί για να αποφευχθούν ζητήματα απορρήτου.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Enter the Liberty Address (example: 44AFFq5kSiGBoZ...)</source>
        <translation>Εισάγετε την Διεύθυνση Liberty (παράδειγμα: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Spendable funds: %1 MLBT. Please wait ~%2 minutes for your whole balance to become spendable.</source>
        <translation>Διαθέσιμο κεφάλαιο: %1 MLBT. Παρακαλώ περιμένετε ~%2 λεπτά για να γίνει διαθέσιμο ολόκληρο το υπόλοιπο σας.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Spend MLBT from a cold (offline) wallet</source>
...
Μέγεθος Δακτυλίου: </translation>
    ...
    <message>
        ...
        <source>Liberty sent successfully</source>
        <translation>Επιτυχής αποστολή Liberty</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Liberty address</source>
        <translation>Διεύθυνση Liberty</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>New Liberty version v%1 is available.</source>
        <translation>H νέα έκδοση του Liberty v%1 είναι διαθέσιμη.</translation>
    </message>
    <message>
        <location filename="../components/UpdateDialog.qml" line="98"/>
        <source>Please visit getliberty.org for details</source>
        <translation>Για λεπτομέρειες παρακαλώ επισκεφτείτε το getliberty.org</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>To be able to communicate with the Liberty network your wallet needs to be connected to a Liberty node. For best privacy it&apos;s recommended to run your own node.</source>
        <translation>Για να μπορείτε να επικοινωνείτε με το δίκτυο Liberty, το πορτοφόλι σας πρέπει να είναι συνδεδεμένο σε κόμβο Liberty. Για καλύτερο απόρρητο, συνιστάται να τρέξετε τον δικό σας κόμβο.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <source>Additionally, you may specify a bootstrap node to use Liberty immediately.</source>
        <translation>Επιπλέον, μπορείτε να καθορίσετε έναν κόμβο εκκίνησης για άμεση χρήση του Liberty.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Welcome to Liberty</source>
        <translation>Καλώς ήλθατε στο Liberty</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Choose this option if this is your first time using Liberty.</source>
        <translation>Κάντε αυτή την επιλογή εάν είναι η πρώτη φορά που χρησιμοποιείτε το Liberty.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Connect your hardware wallet to create a new Liberty wallet.</source>
        <translation>Συνδέστε το υλικό πορτοφόλι σας για την δημιουργία ενός νέου πορτοφολιού Liberty.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Temporary use of remote nodes is useful in order to use Liberty immediately (hence the name bootstrap), however be aware that when using remote nodes (including with the bootstrap setting), nodes could track your IP address, track your &quot;restore height&quot; and associated block request data, and send you inaccurate information to learn more about transactions you make.</source>
        <translation>Η προσωρινή χρήση απομακρυσμένων κόμβων είναι σημαντική για άμεση χρήση του Liberty (εξ ου και το όνομα bootstrap), ωστόσο να γνωρίζετε ότι όταν χρησιμοποιείτε απομακρυσμένους κόμβους (συμπεριλαμβανομένης της ρύθμισης bootstrap), οι κόμβοι θα μπορούσαν να παρακολουθούν τη διεύθυνση IP σας, να παρακολουθούν το &quot;ύψος επαναφοράς&quot; και συσχετισμένα δεδομένα αιτήματος block και να σας στείλουνε ανακριβείς πληροφορίες για να μάθουνε περισσότερα σχετικά με τις συναλλαγές που πραγματοποιείτε.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This mode is ideal for managing small amounts of Liberty. You have access to basic features for making and managing transactions. It will automatically connect to the Liberty network so you can start using Liberty immediately.</source>
        <translation>Αυτή η λειτουργία είναι ιδανική για τη διαχείριση μικρών ποσών Liberty. Έχετε πρόσβαση σε βασικές δυνατότητες για την πραγματοποίηση και διαχείριση συναλλαγών. Θα συνδεθεί αυτόματα στο δίκτυο Liberty, ώστε να ξεκινήσετε να χρησιμοποιείτε το Liberty αμέσως.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>Create portable wallets and use them on any PC. Enable if you installed Liberty on a USB stick, an external drive, or any other portable storage medium.</source>
        <translation>Δημιουργήστε φορητά πορτοφόλια και χρησιμοποιήστε τα σε οποιονδήποτε υπολογιστή. Ενεργοποιήστε εάν εγκαταστήσατε το Liberty σε USB στικάκι, εξωτερική μονάδα δίσκου ή σε οποιοδήποτε άλλο φορητό μέσο αποθήκευσης.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>To be able to communicate with the Liberty network your wallet needs to be connected to a Liberty node. For best privacy it&apos;s recommended to run your own node.

If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Για να μπορείτε να επικοινωνείτε με το δίκτυο Liberty, το πορτοφόλι σας πρέπει να είναι συνδεδεμένο σε κόμβο Liberty. Για καλύτερο απόρρητο, συνιστάται να τρέξετε τον δικό σας κόμβο.
...
<context>
    ...
    <message>
        ...
        <source>This address received %1 liberty, with %2 confirmation(s).</source>
        <translation>Αυτή η διεύθυνση έλαβε %1 liberty, με %2 επιβεβαιώση(-σεις).</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1067"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <source>Would you like to register Liberty GUI Desktop entry?</source>
        <translation>Θα θέλατε να εγγραφείτε στην καταχώρηση Γραφικού Περιβάλλοντος Χρήστη του Liberty Desktop;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>This address received %1 liberty, but the transaction is not yet mined</source>
        <translation>Αυτή η διεύθυνση έλαβε %1 liberty, αλλά η συναλλαγή δεν έχει εξορυχθεί ακόμα</translation>
    </message>
    <message>
